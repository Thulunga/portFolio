...
export function Hero() {
  ...
  return (
    <section id="home" className="pt-20 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <motion.div variants={itemVariants}>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-dark-900 dark:text-white leading-tight">
                Hi, I'm <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Thulunga</span>
              </h1>
            </motion.div>

            <motion.div variants={itemVariants}>
              <h2 className="text-base sm:text-lg md:text-2xl text-blue-600 dark:text-blue-400 font-semibold">
            ...
            <motion.div variants={itemVariants} className="flex flex-col xs:flex-row flex-wrap gap-2 sm:gap-4 pt-2 sm:pt-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white font-semibold py-2.5 sm:py-3 px-4 sm:px-8 rounded-lg transition-all hover:scale-105 text-sm sm:text-base min-h-[44px]"
              >
        ...
        <motion.div
          ...
          className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 text-center text-dark-600 dark:text-dark-400"
        >
